        ...
        <div className="internships-page"> 
            ...
            {Object.keys(groupedInternships).map((alumniName) => ( 
                <div key={alumniName} className="internships-by-alumni"> 
                     <h3>{alumniName} (posted {groupedInternships[alumniName].count} 
{groupedInternships[alumniName].count === 1 ? "internship" : "internships"})</h3> 
                    <ul> 
                    {groupedInternships[alumniName].internships.map((internship) => ( 
                            ...
                            <li key={internship._id}> 
                                ...
                                <p><strong>Accepted Requests:</strong> {internship.acceptedReferralCount || 
0}</p> 
